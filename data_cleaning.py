...
def clean_fca(file_path):
    ...
    - Suppression des lignes avec plus de 80% de valeurs manquantes
    ...
    # 2. Suppression des lignes avec plus de 20% de valeurs manquantes
    # On garde seulement les lignes où au moins 80% des colonnes contiennent des données
    threshold = len(data_cleaned.columns) * 0.7
